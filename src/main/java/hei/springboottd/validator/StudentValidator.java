...
public class StudentValidator {
    public void isStudentFieldvalid(Student student){
        if(student.getReference() == null){
            throw new RuntimeException("reference field is not valid");
        }
        if (student.getFirstName()== null){
            throw new RuntimeException("firstName field is not valid");
        }
        if (student.getLastName()== null){
            throw new RuntimeException("lastName field is not valid");
        }
        if (student.getAge() <= 0){
            throw new RuntimeException("age field is not valid");
        }
    }
